...
public class TestMovieUriMatcher extends AndroidTestCase {
    private static final String TEST_MOVIE_ID = "12314";

    // content://com.example.android.themovieapp.app/movie"
    private static final Uri TEST_MOVIE_DIR = MovieContract.MovieEntry.CONTENT_URI;
    private static final Uri TEST_MOVIE_WITH_ID_DIR = MovieContract.MovieEntry.buildMoviewithID(TEST_MOVIE_ID);
    ...
    public void testUriMatcher() {
        ...
        assertEquals("Error: The TEST_MOVIE_WITH_ID_DIR URI was matched incorrectly.",
