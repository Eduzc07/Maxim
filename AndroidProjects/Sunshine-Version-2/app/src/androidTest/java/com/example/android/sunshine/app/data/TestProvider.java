...
public class TestProvider extends AndroidTestCase {
    ...
    public void testInsertReadWeatherWithDateProvider() {
        ContentValues testValues = TestUtilities.createNorthPoleLocationValues();
        ...
        Log.d(LOG_TAG, "-------  " + weatherInsertUri.toString());
        ...
        for (Map.Entry<String, Object> entry : valueSet) {
            ...
            int idx = weatherCursor.getColumnIndex(columnName);
            String expectedValue = entry.getValue().toString();
            if (idx != -1){
                Log.d(LOG_TAG, "----- Column: " + idx + "    Name: " +columnName + "   Value: " + weatherCursor.getString(idx) + "  expectd: " + expectedValue);
            }
        }
