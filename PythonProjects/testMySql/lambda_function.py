...
def lambda_handler(event = None, context = None):
    ...
    if (len(event) == 4):
        ...
        pression = event[piscPressKey]
        temperatura = event[piscTempKey]
        
        # Insert to MySql
        with conn.cursor() as cur:
            cur.execute("INSERT INTO db_hve.db_piscina VALUES (NULL,%s,%s,%s,%s)",(fecha, equipo, pression, temperatura));
...
if __name__ == "__main__":
    ...
    ini_string = {"Tiempo2":"28/05/2020 16:25:53","Equipo":"HVE","N3temp0":33,"N3temp1":36,"N3temp2":36,"N3temp3":38,"N3temp8":51}
